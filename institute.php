		...
		<div class="content-wrapper">
			<div class="profile-container">
	            ...
	            <div class="pro-education student">
    	        	<h1 class="heading">Available Degrees<button id="add-edu" class="add-button remove">+ Add New</button></h1>
    	        	...
    	        	<center>
	            	    <form id="form-edu" hidden="" class="remove" action="update-degree.php">
	            	    	<input type="text" name="institute" value="<?php echo $_SESSION['login_user'];?>" hidden>
	            	   		...
	            	   		<br/>
	            	   		<input type="text" name="name-of-degree" placeholder="Enter Name of Degree">
	            	   		<br/><br/>
